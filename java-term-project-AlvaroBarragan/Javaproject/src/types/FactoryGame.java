...
private static game parseGame(String line) {
	...
	LocalDate date = LocalDate.parse(fields[3].trim(),DateTimeFormatter.ofPattern("dd/MM/yy"));
	Double patch = Double.valueOf(fields[4].trim());
	String T1id = fields[5].trim();
	List<String> ban1= new ArrayList<String>();
	...
	List<String> ban2= new ArrayList<String>();
